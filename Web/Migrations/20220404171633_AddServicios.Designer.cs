...
namespace Web.Migrations
{
    ...
    [Migration("20220404171633_AddServicios")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.Estados.ESTADOS_SERVICIO", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Eventos.SERVICIO_EVENTO", b =>
                {
                    b.Property<long>("ID_SERVICIO_EVENTO")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ID_SERVICIO_EVENTO");

                    b.HasIndex("ID_EVENTO");

                    b.HasIndex("ID_SERVICIO");

                    b.ToTable("SERVICIO_EVENTO");
                });
            ...
            modelBuilder.Entity("Entidades.Eventos.SERVICIO_EVENTO", b =>
                {
                    ...
                    b.HasOne("Entidades.Servicios.SERVICIOS", "SERVICIOS")
                        .WithMany()
            ...
            modelBuilder.Entity("Entidades.Servicios.SERVICIOS", b =>
                {
                    b.HasOne("Entidades.Estados.ESTADOS_SERVICIO", "ESTADOS_SERVICIO")
                        .WithMany()
                        .HasForeignKey("ID_ESTADO_SERVICIO")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ESTADOS_SERVICIO");
                });
